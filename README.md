...
系统会读取一份合同（Markdown文本），让大模型按固定模板提取信息，

最终输出是一个固定结构的JSON，方便后续入库和业务使用。

## 2. 整体流程

<img width="328" height="795" alt="image" src="https://github.com/user-attachments/assets/16736474-21a1-415d-b67b-318aef96fecf" />
...
<img width="503" height="922" alt="image" src="https://github.com/user-attachments/assets/f25daf7e-01d6-41e7-aa77-531144cfb0b8" />
